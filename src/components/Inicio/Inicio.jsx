...
const Inicio = () => {
  ...
  return (
    <main
      className="main-cont overflow-hidden h-screen pt-[5rem] text-white flex flex-col justify-center items-center relative"
      id="main"
    >
      ...
      <div className="main flex flex-col-reverse lg:flex-row-reverse h-full lg:h-[70%] w-[95vw] justify-center content-center z-[1] overflow-hidden mb-12">
