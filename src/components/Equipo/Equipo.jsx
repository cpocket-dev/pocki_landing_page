    ...
    <>
      <div
        ...
        <div className="features-top flex flex-col justify-start content-center items-center pt-20 pb-4 overflow-visible">
          ...
          <div className="team w-[95vw] md:w-[75vw] bg-white z-[5] flex flex-col mx-auto p-8 rounded-xl gap-4 h-full">
            <p className="text-3xl">Meet our Team Leaders</p>
            <p className="text-xl">
            ...
            <div className="flex gap-4 h-75%">
              <div className="h-full w-1/3 rounded-lg bg-black flex flex-col text-center" onClick={() => setIsOpen(true)}>
                <div className="h-[18rem] bg-white"></div>
