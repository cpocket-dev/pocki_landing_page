    ...
    <>
      ...
      {isOpen && (
        <div className="animate-fade animate-once animate-ease-in-out z-10 fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center">
          <div className="modal-animation rounded-xl shadow-2xl w-[90vw] sm:w-[70vw] xl:w-[90vw] h-1/2 bg-white flex flex-col justify-center items-center content-center relative">
